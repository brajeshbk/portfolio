  ...
  const defaultPosts = [
    {
      ...
      text: "Working on AI-based systems like Robo Car By using Ardiuno ESP 32 has taught me how impactful technology can be when applied to Real World. Combining deep learning with real-world problems is my favorite way to innovate.",
    },
    {
      id: 2,
